...
public class Algorithm {
	...
	public static void main(String[] args) {
		...
		//allows you to choose which languages to use
		TextIO.putln("Select the first language: \nEnglish \nSpanish");
		String lang1 = TextIO.getlnString();
		TextIO.putln("Select the second language: \nEnglish \nSpanish");
		String lang2 = TextIO.getlnString();
		
		//gets words from the users and puts them into arrays
		TextIO.putln("Enter text");
		...
		for (int i = 0; i < badWords; i ++){
			System.out.println(Arrays.toString(suggestions[i]));
		}
	}
}
